...
Join https://t.me/TeamAPURBO_Channel
'''
#!/usr/bin/python3
...
emad=[]
os.system("https://t.me/TeamAPURBO_Channel")
def mail(emad, limit):
    while True:
...
def main():
    ...
    print(Panel.fit("[bold green]Developer     —>>     Apurbo Fire 5.0"))
    print("")
    print(meth)
...
def file_subb(Gmail,psslist):
    global oks,done
    sys.stdout.write(f"\r  \033[38;5;46m[APURBO-XD] {done}|{str(len(oks))}");sys.stdout.flush()
